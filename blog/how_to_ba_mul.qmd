...
plot_bland_altman <- function(data) {
  data %>%
    ...
    summarise(
      ...
      # Calculate the lower limit of agreement (LoA) as Bias - 1.96 * standard deviation
      LoA_Lower = Bias - 1.96 * sd(Difference),
      # Calculate the upper limit of agreement (LoA) as Bias + 1.96 * standard deviation
    ...
    # Add a dotted horizontal line for the lower limit of agreement (LoA_Lower)
    geom_hline(aes(yintercept = LoA_Upper), color = "#C5050C", linetype = "dotted") +
    # Add a dotted horizontal line for the upper limit of agreement (LoA_Upper)
