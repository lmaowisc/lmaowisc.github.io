...
- `research.qmd` and `research.css`: Research page content and agency logo styling. CASCADE belongs under active funding with Lu Mao identified as UW sub-award PI. Agency images use `funding-agency-logo` to blend their white backgrounds into the page.
